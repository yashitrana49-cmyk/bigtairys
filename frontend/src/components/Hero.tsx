...
export default function Hero() {
  return (
    <section className="relative hero min-h-screen pt-0 py-8 sm:py-24 overflow-hidden">
    ...
    <HeroShirtSlider />
    {/* TEXT BETWEEN */}
    <p className="hero-mid-text w-full mt-4">
      REPRESENTING STREET CULTURE
    </p>
    <p className="hero-end-text w-full mt-2">
